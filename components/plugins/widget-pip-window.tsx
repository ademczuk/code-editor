...
export function WidgetPipWindow() {
  ...
  return (
    ...
    >
      ...
      {/* Resize edges */}
      <div className="absolute -top-[3px] left-[6px] right-[6px] h-[6px]" style={{ cursor: CURSOR_MAP.n }} onMouseDown={startResize('n')} />
      <div className="absolute -bottom-[3px] left-[6px] right-[6px] h-[6px]" style={{ cursor: CURSOR_MAP.s }} onMouseDown={startResize('s')} />
      <div className="absolute top-[6px] -left-[3px] bottom-[6px] w-[6px]" style={{ cursor: CURSOR_MAP.w }} onMouseDown={startResize('w')} />
      <div className="absolute top-[6px] -right-[3px] bottom-[6px] w-[6px]" style={{ cursor: CURSOR_MAP.e }} onMouseDown={startResize('e')} />
      <div className="absolute -top-[3px] -left-[3px] w-[10px] h-[10px]" style={{ cursor: CURSOR_MAP.nw }} onMouseDown={startResize('nw')} />
      <div className="absolute -top-[3px] -right-[3px] w-[10px] h-[10px]" style={{ cursor: CURSOR_MAP.ne }} onMouseDown={startResize('ne')} />
      <div className="absolute -bottom-[3px] -left-[3px] w-[10px] h-[10px]" style={{ cursor: CURSOR_MAP.sw }} onMouseDown={startResize('sw')} />
      <div className="absolute -bottom-[3px] -right-[3px] w-[10px] h-[10px]" style={{ cursor: CURSOR_MAP.se }} onMouseDown={startResize('se')} />
    </div>
  )
}
